...
Consta de las siguientes partes:					
 ...
 Entrada:                                                           					
     - Fichero SAS sin formatos: 	 ESdEhogar_2023.sas7bdat				
 Salida:                                                           					
     - Fichero SAS con formatos: 	  ESdEhogar_2023_conFormato.sas7bdat				
...
*%let siglas_periodo = ESdEhogar_2023;
...
"01"="Menos de 1100 euros"
"02"="De 1100 a menos de 1650 euros"
"03"="De 1650 a menos de 2300 euros"
"04"="De 2300 a menos de 3800euros"
"05"="De 3800 euros en adelante"
"99"="No contesta"
;
value $TSINO
...
FORMAT NADULTOS N_99NC.;
FORMAT NMENORES N_99NC.;
FORMAT A9 $TSINO.;
...
FORMAT A5_otra $T5A_otr.;
FORMAT A10 $T10A.;
FORMAT A11 $T11A.;
FORMAT A12 $T12A.;
FORMAT B13 $T13B.;
FORMAT B14 $TSINOC.;
FORMAT B15_2 $T15CNAE.;
FORMAT B16_2 $T16CNO.;
FORMAT B17 $T17B.;
FORMAT B18 $TSINOC.;
FORMAT B19a_2 $T15CNAE.;
FORMAT B19b_2 $T15CNAE.;
FORMAT B20a_2 $T16CNO.;
FORMAT B20b_2 $T16CNO.;
FORMAT B21a $T21aB.;
FORMAT B21b $T21bB.;
...
FORMAT D23_11 $TSINO.;
FORMAT D24 $T24D.;
FORMAT INGRESOS $TINGRES.;


RUN;
/* FIN PROGRAMA: Microdatos en SAS: ESdEhogar_2023.sas*/
