...
Consta de las siguientes partes:					
 ...
 Entrada:                                                           					
     - Fichero SAS sin formatos: 	 EESEhogar_2020.sas7bdat				
 Salida:                                                           					
     - Fichero SAS con formatos: 	 EESEhogar_2020_conFormato.sas7bdat				
					
Donde:					
	* Operación: Encuesta Europea de Salud en España_Cuestionario Hogar (EESEhogar)				
	* Periodo: 2020				
					
************************************************************************************************************************/					
					
/*1) Definir la librería de trabajo: introducir el directorio que desee como librería					
(se da como ejemplo 'C:\Mis resultados'), y copiar en ese directorio el fichero sas "EESEhogar_2020.sas7bdat"*/					
...
RUN;
/* FIN PROGRAMA: Microdatos en SAS: EESEhogar_2020.sas*/
