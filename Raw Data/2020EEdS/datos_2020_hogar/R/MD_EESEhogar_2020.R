#################################################################################
# Nombre del programa:	MD_EESEhogar_2020.R                                          
# Autor:              	INE
# Version:            	4.1
# Última modificación: 	15 septiembre 2017
#                                                                                
# Descripción: 
#	Este programa procesa un fichero de microdatos (md_EESEhogar_2020.txt)
#   a partir de un fichero de metadatos (dr_EESEhogar_2020.xlsx) que contiene 
#   el diseño de registro del archivo de microdatos. 
#     EESEhogar.: Operación estadística
#     2020: Año(s) de producción de los datos
#
# Entrada:                                                           
#     - Diseño de registro: 	dr_EESEhogar_2020.xlsx
#     - Archivo de microdatos: 	md_EESEhogar_2020.txt
# Salida: 
...
fichero_micro <- "md_EESEhogar_2020.txt"
fichero_meta  <- "dr_EESEhogar_2020.xlsx"
