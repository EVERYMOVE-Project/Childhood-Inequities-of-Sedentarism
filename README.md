...
Code for a study on **inequality trends in sedentarism among children aged 6 to 15 years in Spain**, using the **Relative Index of Inequality (RII) and Slope Index of Inequality (SII)**.  
Microdata obtained from the **Instituto Nacional de Estadística (INE)**.
---
