...
table(ense2011$estudios, useNA = "ifany")
...
summary(hogar2023$A10)
hogar2023$A10 <- factor(hogar2023$A10)
# hogar2023
...
sum(is.na(hogar2023$estudios))
summary(hogar2023$estudios)
hogar2023$estudios <- factor((hogar2023$estudios))
...
summary(ense2023$estudios)
ense2023$estudios <- factor(ense2023$estudios)
...
summary(ense2006$estudios)
table(ense2006$education_3, useNA = "ifany")
View(ense2006)
## ENSE 2011 ####
ense2011 <- ense2011 %>% 
  mutate( 
