...
adultos2003 <- adultos2003 %>% select(
  NIDENTIF, SEXO, EDAD, N_INF, SUJ_ENTR, SPCLASE, FACTOR, D_ACFISO,
  PESO, ALTURA, CCAA, TMUNI
)
...
adultos2003$edad <- as.numeric(adultos2003$edad)
...
adultos2006 <- adultos2006 %>% select(
  NIDENTIF, SEXO, EDAD, P5_0_2, NORDEN, SPCLASE, FACTOR, H3_93, TMUNI, ESTRATO,
  L1_128, L1_129, ASIMC, CCAA
)
# rename relevant variables
adultos2006 <- adultos2006 %>% rename( # n = 29,478
  id = NIDENTIF,
  n_inf = P5_0_2,
  sexo = SEXO,
  edad = EDAD,
...
# join home-level info directly to adult ID
adultos2006$edad <- as.numeric(adultos2006$edad)
ense2006m$edad <- as.numeric(ense2006m$edad) # to keep variable same type
...
summary(ense2017m$estrato) # after joining, n = 4 missing of estrato
...
# when join with id and n_inf get n = 446 missing of estrato 
...
# A tibble: 15 × 3
# Variable      NA_Count N_percentage
# <chr>            <int>        <dbl>
# 1 id                   0        0    
# 2 sexo                 0        0    
# 3 edad                 0        0    
...
# 6 clase              566        9.34 
# 7 factor               0        0    
# 8 sedentarismo       566        9.34 
# 9 peso               566        9.34 
# 10 altura               0        0    
# 11 imc                547        9.02 
# 12 estrato              0        0    
# 13 ccaa                 0        0    
# 14 nacionalidad       562        9.27 
# 15 survey               0        0   
...
## raw adultos2017 data missingness
na_table_2017a <- adultos2017 %>%
  summarise_all(~sum(is.na(.))) %>%
  pivot_longer(everything(), names_to = "Variable", values_to = "NA_Count") %>%
  mutate(N_percentage = NA_Count / nrow(adultos2017)*100)
print(na_table_2017a, n = 577)
...
# 13 ccaa                 0        0    
# 14 n_inf              653        6.67 
# 15 nacionalidad        33        0.337
# 16 sedentarismo2     9131       93.3  
# 17 survey               0        0    
# 18 factor2              0        0    
# 19 clase_tr           123        1.26 
# 20 urb_rur              0        0    
# 21 obesity           3376       34.5  
# 22 overweight        3376       34.5  

summary(ense2006$sedentarismo)
summary(ense2006m$sedentarismo)
summary(ense2006a$sedentarismo2)
...
# 15 survey               0        0    
# 16 factor2              0        0    
# 17 clase_tr           899       14.8  
# 18 urb_rur              0        0    
# 19 obesity           2134       35.2  
# 20 overweight        2134       35.2  
# 21 PA                 632       10.4  
...
# 15 survey               0       0     
# 16 factor2              0       0     
# 17 clase_tr           468       6.81  
# 18 urb_rur              4       0.0582
# 19 obesity           1322      19.2   
# 20 overweight        1322      19.2   
# 21 PA                  38       0.553
...
# 15 survey               0       0     
# 16 factor2              0       0     
# 17 clase_tr           125       2.99  
# 18 urb_rur              2       0.0479
# 19 obesity            890      21.3   
# 20 overweight         890      21.3   
# 21 PA                 123       2.94  
...
table(test$clase, test$survey)
table(dt$clase, dt$survey)
table(test$edad, test$survey)
