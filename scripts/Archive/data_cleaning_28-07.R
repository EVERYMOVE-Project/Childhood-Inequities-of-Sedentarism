...
joined_clean$edad_cat <- factor(joined_clean$edad_cat, levels = c("0-5", "6-11", "12-15"))

# Database MAIHDA ####
maihda <- joined_clean %>% 
  select(sexo, edad, edad_cat, clase, survey, sedentarismo, nacionalidad, urb_rur, ccaa)
