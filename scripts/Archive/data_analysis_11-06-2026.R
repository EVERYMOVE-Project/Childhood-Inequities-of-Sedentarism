...
save(rii_sedentarism_f_clase, file = "Datasets/clase_tr_2/new/rii_sedentarism_overall_clase_females.RData")
...
save(rii_sedentarism_m_clase, file = "Datasets/clase_tr_2/new/rii_sedentarism_overall_clase_males.RData")
...
save(sii_sedentarism_f_clase, file = "Datasets/clase_tr_2/new/sii_sedentarism_clase_females.RData")
...
save(sii_sedentarism_m_clase, file = "Datasets/clase_tr_2/new/sii_sedentarism_clase_males.RData")
...
save(sii_sedentarism_clase, file = "Datasets/clase_tr_2/new/sii_sedentarism.RData")
...
fig_rii_class_sex
ggsave("Figures/clase_tr_2/new/fig_rii_class_sex.png", width = 4000, height = 2200, dpi=300, units = "px")
...
fig_sii_class_sex
ggsave("Figures/clase_tr_2/new/fig_sii_class_sex.png", width = 4000, height = 2200, dpi=300, units = "px")
...
fig_sii_rii
ggsave("Figures/clase_tr_2/new/fig_sii_rii.png", width = 4000, height = 2200, dpi=300, units = "px")
...
apc_dta_overall <- rii_sedentarism_clase %>%
  filter(
    strata == "Overall" # Change Overall, Girls, Boys
  ) %>%
  mutate(
