...
# joined_clean_6_2 <- joined_6 %>% 
#   drop_na(edad, sexo, sedentarismo, clase, ccaa, urb_rur)
# save(joined_clean_6, file = "joined_clean_6_2.RData")
...
save(joined_clean_6, file = "joined_clean_6.RData")
